...
**The light theme gets the chroma push** (inverted from the first attempt). Warm paper washes pale petals out by simultaneous contrast; on dark the colors glow unaided. The original code boosted dark instead, and a side-by-side harness exposed it.
...
**No outlines, anywhere.** Petals separate as in photographs: a double contact shadow (crisp line opening into penumbra) under every covering edge, a thin rim of light on the waxy margin, one directional light across the corolla.
